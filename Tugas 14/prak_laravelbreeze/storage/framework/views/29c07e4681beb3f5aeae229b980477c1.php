...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.container','data' => ['class' => 'max-w-7xl mx-auto sm:px-6 lg:px-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'max-w-7xl mx-auto sm:px-6 lg:px-8']); ?>
...
<?php $component->withAttributes(['class' => 'relative']); ?>
                ...
                <div class="p-6 pb-0">
                    <?php if($store->logo): ?>
                        <img src="<?php echo e(Storage::url($store->logo)); ?>" alt="<?php echo e($store->name); ?>" class="size-16 rounded-lg">
                    <?php else: ?>
                    <div class="size-16 rounded-lg bg-zinc-600">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($store->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(str($store->description)->limit(100)); ?>
...
<?php endif; ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('stores.edit', $store)); ?>" class="underline text-blue-600">Edit</a>
                        <?php endif; ?>   
                    <?php endif; ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze\resources\views/stores/index.blade.php ENDPATH**/ ?>