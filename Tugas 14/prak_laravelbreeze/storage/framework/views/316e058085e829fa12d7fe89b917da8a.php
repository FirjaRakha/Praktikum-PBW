...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Verify Email'); ?>

     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-zinc-800 leading-tight">
            <?php echo e(__('Verify Email')); ?> (<span class="text-zinc-500"><?php echo e(auth()->user()->email); ?></span>)
        </h2>
     <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.container','data' => ['class' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => '']); ?>
        <div class="max-w-2xl bg-white shadow-sm border rounded-lg p-6">
...
<?php endif; ?>
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('profile.edit')); ?>" class="underline text-zinc-600 hover:text-zinc-900 text-sm">
                    Edit Profile
                </a>
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <button type="submit" class="underline text-sm text-zinc-600 hover:text-zinc-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>