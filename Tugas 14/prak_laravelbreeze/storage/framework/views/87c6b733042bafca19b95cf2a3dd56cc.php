...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(str($store->description)->limit()); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($store->user_id == auth()->user()->id): ?>
                                <a href="<?php echo e(route('stores.edit', $store)); ?>" class="underline text-blue-500">Edit</a>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze2\resources\views/stores/index.blade.php ENDPATH**/ ?>