...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title','List Stores'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.stores.item','data' => ['isAdmin' => $isAdmin,'store' => $store]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['isAdmin' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isAdmin),'store' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($store)]); ?>
...
<?php endif; ?><?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze2\resources\views/stores/list.blade.php ENDPATH**/ ?>