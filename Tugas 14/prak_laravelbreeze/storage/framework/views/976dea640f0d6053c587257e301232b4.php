...
<?php $component->withAttributes(['class' => 'relative']); ?>
                    <a href="<?php echo e(route('products.show', [$store, $product])); ?>" class="absolute size-full inset-0"></a>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(Number::currency($product->price, 'IDR')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze2\resources\views/stores/show.blade.php ENDPATH**/ ?>