    ...
    <?php $__env->slot('title', 'Verify Email'); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Verify Email')); ?> (<span class="text-gray-500"><?php echo e(auth()->user()->email); ?></span>)
        </h2>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('profile.edit')); ?>" class="underline text-gray-600 hover:text-gray-900 text-sm">
                    Edit Profile
                </a>
...
<?php endif; ?><?php /**PATH C:\Users\ASUS\.config\herd\config\valet\Sites\prak_laravelbreeze2\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>